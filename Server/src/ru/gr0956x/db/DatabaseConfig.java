 ...
 *   в пакете {@code ru.gr0956x.db}</li>
 * </ul>
 * <p>
...
@EnableJpaRepositories(basePackages = "ru.gr0956x.db.repository")
@ComponentScan(basePackages = "ru.gr0956x.db")
...
public class DatabaseConfig {
    ...
    entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("ru.gr0956x.db.entity");
